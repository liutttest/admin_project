	...
	var build = {
		bind : function() {
			...
			$("tbody").delegate(".setDefault", "click", function() {
				...
				$.ajax({
					url : contentPath + '/faMessageTemplate/setDefault?tid=' + tid,
					type : 'POST',
					dataType : 'json',
					success : function(data) {
						if (data.status == 'success') {
							location.href = contentPath + "/faMessageTemplate";
						}
					},
					error : function() {
					}
			...
			$("tbody").delegate(".delete", "click", function() {
				...
				var tid = $(this).attr("data-id");
				$.ajax({
					url : contentPath + '/faMessageTemplate/remove?tid=' + tid,
					type : 'POST',
					dataType : 'json',
					success : function(data) {
						if (data.status == 'success') {
			...
			$("tbody").delegate(".edit", "click", function() {
				...
				$.ajax({
					url : contentPath + '/faMessageTemplate/update',
					type : 'POST',
					data : data,
					dataType : 'json',
					success : function(data) {
			...
			$('#save').on('click', function() {
				...
				param.tid = $('#tid').val();
				$.ajax({
					url : contentPath + '/faMessageTemplate/create',
					type : 'POST',
					data : param,
					dataType : 'json',
					success : function(data) {
