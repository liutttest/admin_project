...
<div class="main-content">
	...
	<div>
		<table id="sample-table-2" class="table table-striped table-bordered table-hover">
			<thead>
				<tr>
					<th class="c-align col-sm-4">模板标题</th>
					<th class="c-align col-sm-5">站内信标题</th>
					<th class="c-align col-sm-1">场景</th>
					<th class="c-align col-sm-1">是否为默认</th>
					<th class="c-align col-sm-1">操作</th>
				</tr>
			</thead>
...
<script src="${contentPath}/js/fa_message_template/fa_message_template.js"></script>
<script type="text/javascript">
	jQuery(function($) {
		var oTable1 = 
		$('#sample-table-2')
