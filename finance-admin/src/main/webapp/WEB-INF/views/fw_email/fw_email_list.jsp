		...
		<table id="sample-table-2" class="table table-striped table-bordered table-hover">
			<thead>
				<tr>
					...
					<th class="c-align col-sm-9">消息内容</th>
			...
			<tbody>
			<c:forEach items="${list}" var ="fwEmail">
				<tr>
					<%-- <td>
						${fwMessage.title}
					</td> --%>
					<td class="c-align">${fwEmail.receviceName}</td>
					<td>${fwEmail.content}</td>
					<td class="c-align">${fwEmail.sendTime}</td>
					<%-- <td class="c-align">
