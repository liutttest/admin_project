		...
		<table id="sample-table-2" class="table table-striped table-bordered table-hover mytable">
			<thead>
				<tr>
					...
					<th class="v-align col-sm-2 c-align">类型</th>
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="form-group">
		                      ...
		                      <div  class="col-sm-9" >
		                         <label class="col-sm-3 control-label" id="compensatory-money"></label>
		                      </div>
		                  </div>
						  ...
						  <div class="form-group">
		                      ...
		                      <div  class="col-sm-9" >
		                      <label class="col-sm-3 control-label" id="compensatory-rate"></label>
		                      </div>
		                  </div>
		                  <div class="space-4"></div>
		                  <div class="form-group">
		                      ...
		                      <div  class="col-sm-9" >
		                      <label class="col-sm-3 control-label" id="compensatory-total"></label>
		                      </div>
 ...
 <script type="text/javascript">
	...
	jQuery(function($) {
		...
		.dataTable( {
			...
			"bServerSide" : true,
			"searching": true,
			"sAjaxSource" : contentPath + "/faOverdueInfo/getHistoryFaOverdueInfoList",
			"aoColumns" : [   
                           {"mData" : "comName"},   
                           {"mData" : "loanNo"},   
                           {"mData" : "applyPassTime"},   
           ...
           "aoColumnDefs":[  
						   ...
						   },
						   {
							    ...
							    "mRender":function(a,b,c,d){
							    	...
							    	if (c.isPrincipal > 0)
						        	{
							    		result = '<span class="label label-sm label-primary arrowed arrowed-right">本金</span>';
						        	}
							    	if(c.isInterest > 0){
							    		result =result+'<span class="label label-sm label-primary arrowed arrowed-right">利息</span>';
							    	}
					        		return result;
							    }
						   },
		...
		var bind = {
				bindEvent : function() {
					...
					$("tbody").delegate(".js－overduce-history", "click", function() {
						...
						action.getTemplate(); */
						action.getHistoryList(loanNo,month);
			...
			var action = {
			  		 ...
			  		 $.ajax({
							...
							success : function(data){
								...
								if(data.status=='success'){
									...
									var total = parseInt(money)+parseInt(rate);
				...
				getHistoryList:function(loanNo,month){
