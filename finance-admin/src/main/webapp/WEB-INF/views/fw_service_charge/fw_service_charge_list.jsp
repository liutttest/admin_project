			...
			<c:forEach items="${list}" var ="item">
				...
				<td class="c-align">
					<c:if test="${item.serviceChargeState != '01'}">
						<a class="flow-turn-todo" href="${contentPath}/fwServiceCharge/doConfirmBank?bsinessId=${item.bsId}&businessType=01" onclick="return confirm('该业务服务费金额为￥${item.serviceCharge}元，确认已收取吗?')">确认收款</a>
					</c:if>
