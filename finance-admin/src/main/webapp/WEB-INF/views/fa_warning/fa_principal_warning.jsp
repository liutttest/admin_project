...
<div class="main-content">
	...
	<div class="col-xs-12 tabbable">
        <ul class="nav nav-tabs">
          <li role="presentation" class="active"><a class="day-tab" data-toggle="tab" data-value="30" href="#">30天内到期记录</a></li>
          <li role="presentation"><a class="day-tab" data-toggle="tab" data-value="15" href="#">15天内到期记录</a></li>
          <li role="presentation"><a class="day-tab" data-toggle="tab" data-value="7" href="#">7天内到期记录</a></li>
        </ul>
		...
		<table id="sample-table-2" class="table table-striped table-bordered table-hover mytable">
			<thead>
				<tr>
					...
					<th class="v-align col-sm-2 c-align">剩余还款金额(元)</th>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="blue bigger" id="warning-title">还本金预警</h4>
			</div>
 ...
 <script type="text/javascript">
	...
	jQuery(function($) {
		...
		.dataTable( {
			...
			"bServerSide" : true,
			"searching": true,
			"sAjaxSource" : contentPath + "/faWarning/getPrincipleList",
			"aoColumns" : [   
                           {"mData" : "comName"},   
                           {"mData" : "loanNo"},   
                           {"mData" : "applyPassTime"},   
                           {"mData" : "expitedTime"},   
                           {"mData" : "repaymentMoney"},
                           {"mData" : "busId"}
                           ],
           ...
           "aoColumnDefs":[  
						   ...
						   },
						   {
							    ...
							    "mRender":function(a,b,c,d){
							    	...
							    	return c.repaymentMoney.toFixed(2);
							    }
						   },
                           {
