...
<div class="main-content">
	...
	<div>
		<table id="sample-table-2" class="table table-striped table-bordered table-hover">
			<thead>
				<tr>
					<th class="c-align col-sm-2">接收人</th>
					<th class="c-align col-sm-8">消息内容</th>
			...
			<tbody>
			<c:forEach items="${list}" var ="fwSms">
				<tr>
					<%-- <td>
						${fwMessage.title}
					</td> --%>
					<td class="c-align">${fwSms.receviceName}</td>
					<td>${fwSms.content}</td>
					<td class="c-align">${fwSms.sendTime}</td>
					<%-- <td class="c-align">
